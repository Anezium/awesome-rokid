...
| `AI Glasses Manager` | `System Utility` | Comprehensive Rokid glasses manager for Wi-Fi, Bluetooth, app install/uninstall, memory cleanup, files, gallery, camera tools, App Store browsing, sound and volume controls, voice features, activation recovery, and multilingual glasses-friendly settings. | [Official APK](https://github.com/Phantom-Not/ai-glasses-manager-releases/releases/download/v2.6.0/AI-Glasses-Manager-2.6.0.apk) |

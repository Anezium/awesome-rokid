...
| `AI Glasses Manager` | `System Utility` | Independent multilingual manager for Rokid glasses with connectivity settings, app and file management, gallery, camera tools, system controls, and an integrated app store. | [Latest Release](https://github.com/Phantom-Not/ai-glasses-manager-releases/releases/latest) |

...
| `Rokid Zoom Camera` | `Glasses App` | Unofficial camera prototype for Rokid Glasses with temple-swipe zoom, zoomed photo capture, and physical-button video recording. | [Repo](https://github.com/ksuzukigh/rokid-zoom-in-camera) |
...
| `AI Glasses Manager` | `System Utility` | Independent multilingual manager for Rokid glasses, covering connectivity, apps, files, gallery, camera tools, system controls, voice features, activation recovery, and an integrated App Store. This developer-published release replaces the outdated Rokid Manager 1.5 entry and is not affiliated with Rokid. | [Developer Release](https://github.com/Phantom-Not/ai-glasses-manager-releases/releases/download/v2.6.0/AI-Glasses-Manager-2.6.0.apk) |
...
| `Rokikoma` | `Overlay Pet App` | Offline animated multi-legged robot companion for Rokid AI Glasses, with an original startup song, synchronized lyrics and dancing, and smooth wall, ceiling, jump, and observation animations. | [Repo](https://github.com/tenru-do/rokikoma) |
| `Lokizaru` | `Overlay Pet App` | Offline green desktop pet for Rokid AI Glasses with 65 transparent animation frames, random walking, jumping, sleeping, reactions, and built-in sounds. | [Repo](https://github.com/tenru-do/lokizaru) |
